...
- **匯入你自己的文案**：在步驟 2 直接貼上文案或上傳 **.txt / .md / .docx**，可「直接轉成投影片」（不需 API、即時）或「用 AI 整理成簡報」；Markdown（`#` 大標、`##` 每頁、`-` 重點）結構最準，純文字以空行分頁。產出的都是可編輯大綱。
...
- **8 種設計風格**：Avon 官方品牌、企業專業藍、優雅玫瑰金、簡約黑白、活力漸層、學術沉穩、科技深色、暖陽橙；每種有即時預覽。
- **Avon 官方品牌合規版**：依 Avon 品牌規範（Avon Red `#E5004B`、Lato 字體、乾淨結構、避免漸層/過度陰影、官方 logo 自動置入、中英雙語選項）。選此風格時自動切換為「乾淨模式」，其餘風格維持漸層/卡片的精緻視覺。
