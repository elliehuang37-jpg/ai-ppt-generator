...
const PURPOSES = [
  {
    id: "strategy",
    icon: "🎯",
    name: "商業策略簡報", nameEn: "Business Strategy",
    desc: "向管理層說明策略方向、市場與成長計畫", descEn: "Present strategy, market and growth to leadership",
    structure: "標題頁、執行摘要、市場與背景、機會與挑戰、策略主軸、行動方案、財務預估、時程路線圖、風險與對策、結論與下一步"
  },
  {
    id: "businesscase",
    icon: "📊",
    name: "商業提案 / Business Case", nameEn: "Business Case / Proposal",
    desc: "提出方案、論證可行性並爭取資源", descEn: "Make a case, prove feasibility, win resources",
    structure: "標題頁、背景與問題、機會評估、可選方案比較、建議方案、投資與效益（ROI）、實施計畫、風險評估、結論與需求（the ask）"
  },
  {
    id: "sales",
    icon: "🚀",
    name: "銷售 / 產品推廣", nameEn: "Sales / Product Pitch",
    desc: "向客戶介紹產品價值、打動人心並促成行動", descEn: "Pitch product value and drive action",
    structure: "吸睛開場、客戶痛點、解決方案、產品亮點與差異化、成功案例 / 見證、方案與價格、行動呼籲（CTA）"
  },
  {
    id: "training",
    icon: "🎓",
    name: "教育訓練 / 課程", nameEn: "Training / Course",
    desc: "教學、培訓或工作坊使用的教材簡報", descEn: "Teaching, training or workshop materials",
    structure: "封面、課程目標、議程大綱、核心概念、步驟與方法、實例示範、練習 / 互動、重點回顧、延伸資源"
  },
  {
    id: "schoolreport",
    icon: "📚",
    name: "學校報告 / 專題", nameEn: "School Report / Project",
    desc: "課堂報告、專題成果或讀書心得", descEn: "Class report, project results or book review",
    structure: "封面（題目/組別/姓名）、研究動機與目的、背景介紹、研究方法、內容分析、發現與成果、結論、心得與反思、參考資料"
  },
  {
    id: "research",
    icon: "🔬",
    name: "研究成果發表", nameEn: "Research Presentation",
    desc: "學術或研究導向的正式發表", descEn: "Academic or research-oriented presentation",
    structure: "標題頁、研究背景、研究問題與假設、文獻回顧、研究方法、數據與結果、討論、結論與貢獻、未來方向、參考文獻"
  },
  {
    id: "workreport",
    icon: "📈",
    name: "工作匯報 / 月報", nameEn: "Work Report / Review",
    desc: "週報、月報、季度回顧與成果彙整", descEn: "Weekly, monthly or quarterly review",
    structure: "封面、本期重點摘要、目標達成狀況、關鍵數據與成果、進行中項目、遇到的問題與對策、下期計畫、需要的支援"
  },
  {
    id: "general",
    icon: "💡",
    name: "一般主題簡報", nameEn: "General Topic",
    desc: "不確定？讓 AI 依主題自動安排最合適的架構", descEn: "Not sure? Let AI choose the best structure",
...
const THEMES = [
  {
    ...
    id: "avon",
    name: "Avon 官方品牌", nameEn: "Avon Official",
    subtitle: "Avon Red · Lato · 官方規範乾淨版", subtitleEn: "Avon Red · Lato · clean brand-compliant",
  ...
  {
    id: "corporate",
    name: "企業專業藍", nameEn: "Corporate Blue",
    subtitle: "穩重 · 可信賴 · 商務首選", subtitleEn: "Solid · trustworthy · business default",
  ...
  {
    id: "rosegold",
    name: "優雅玫瑰金", nameEn: "Elegant Rose Gold",
    subtitle: "柔和 · 精緻 · 美妝 / 品牌", subtitleEn: "Soft · refined · beauty / brand",
  ...
  {
    id: "minimal",
    name: "簡約黑白", nameEn: "Minimal Mono",
    subtitle: "極簡 · 大氣 · 內容為王", subtitleEn: "Minimal · bold · content-first",
  ...
  {
    id: "vibrant",
    name: "活力漸層", nameEn: "Vibrant Gradient",
    subtitle: "年輕 · 吸睛 · 行銷 / 提案", subtitleEn: "Young · eye-catching · marketing / pitch",
  ...
  {
    id: "academic",
    name: "學術沉穩", nameEn: "Academic Calm",
    subtitle: "嚴謹 · 清晰 · 報告 / 研究", subtitleEn: "Rigorous · clear · report / research",
  ...
  {
    id: "techdark",
    name: "科技深色", nameEn: "Tech Dark",
    subtitle: "前衛 · 數據 · 科技 / 新創", subtitleEn: "Modern · data · tech / startup",
  ...
  {
    id: "warmsun",
    name: "暖陽橙", nameEn: "Warm Sun",
    subtitle: "親切 · 正面 · 教學 / 內部", subtitleEn: "Friendly · positive · teaching / internal",
