...
- **7 種簡報目的**：商業策略、商業提案 (Business Case)、銷售推廣、教育訓練、學校報告、研究發表、工作匯報，以及「一般主題」自動安排架構。
- **AI 自動產生大綱**：先給你結構化的草稿，可逐張**編輯標題、增刪重點、增刪整張投影片**，確認後再進設計。
- **7 種設計風格**：企業專業藍、優雅玫瑰金、簡約黑白、活力漸層、學術沉穩、科技深色、暖陽橙；每種有即時預覽。
